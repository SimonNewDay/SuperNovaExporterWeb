...
const globalBaseBlack = "rgba(0,0,0,255)";
 ...
 const semanticContentContentaccent = "rgba(0,30,240,255)";
 ...
 const semanticBackgroundBackgroundaccent = "rgba(221,225,255,255)";
 const semanticBackgroundBackgroundaccentalt = "rgba(0,30,240,255)";
 const semanticBorderBorderprimary = "rgba(198,198,198,255)";
 const semanticBorderBorderinverse = "rgba(255,255,255,255)";
 const semanticInteractivePrimaryInteractivedefault = "rgba(0,30,240,255)";
 ...
 const globalThemePrimaryThemedefault = "rgba(0,30,240,255)";
 const globalThemePrimaryThemedark = "rgba(0,24,192,255)";
 const globalThemeSecondaryThemedefault = "rgba(0,182,240,255)";
 const globalThemeSecondaryThemedark = "rgba(0,146,204,255)";
 const globalThemeTertiaryThemedefault = "rgba(221,225,255,255)";
...
export const Colors = {
    ...
    /** Used for primary content, such as Headings. */
    ...
    /** Used sparingly to add a splash of a theme accent colour. */
            semanticContentContentaccent,
    /** Used for the predominant page background colour. */
            semanticBackgroundBackgroundprimary,
    /** Used to subtly differentiate different page sections. */
            semanticBackgroundBackgroundsecondary,
    /** Used sparingly to add a splash of a theme accent colour. */
            semanticBackgroundBackgroundaccent,
    /** Used sparingly to add a splash of a theme accent colour. */
            semanticBackgroundBackgroundaccentalt,
    /** Used for most separators and borders, such as Inputs. */
    ...
    /** Used for the Interactive focus state. */
